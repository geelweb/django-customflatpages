...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomFlatPage.order'
        db.add_column(u'customflatpages_customflatpage', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomFlatPage.order'
        db.delete_column(u'customflatpages_customflatpage', 'order')
